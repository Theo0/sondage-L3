...
class Form {
	...
	public function add($field, $name, $opt1=null, $opt2=null) {

		if (!isset($this->fields[$name])) {

			$field = 'Form_'.ucfirst($field);
			$field_object = new $field($name, $this, $opt1, $opt2);
...
// ---------------------------------------------------------------------------
class Form_HTML extends Form_Input {
...
class Form_Number extends Form_Text {
	...
	public function __construct($name, $form, $min = null, $max = null) {
...
// ---------------------------------------------------------------------------
class Form_Tel extends Form_Text {

	public function __construct($name, $form, $pattern=null) {
